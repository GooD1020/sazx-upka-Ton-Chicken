...
local win = SomeLib:Window("sazx", _G.Color, _G.Toggle)

local serv = win:Server(" HUB | ไก่ตัน🐔","")
...
AutoFarm:Toggle("Auto SetSpawn Point",nil,function(x)
    _G.Set = x
end)
...
AutoFarm:Button("fast attack op คนที่อยากได้เวลตันเร็ว",function()
...
AutoFarm:Button("Redeem All code",function()
    function Code(Text)
